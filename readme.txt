...
OsmFlickr is a web application to manage and create OpenStreetMap machine tag for Flickr Photo.

It's based on some OpenSource project :
...
Portions created by the Initial Developers are Copyright (C) 2013 the Initial Developer. All Rights Reserved.
